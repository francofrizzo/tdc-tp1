...
aplicarlo sobre una nueva fuente $\mathcal{S}_1'$, resultante de
restringir la fuente $\mathcal{S}_1$ a los nodos de la otra componente con
topología estrellada, es decir, la que tiene como centro al \emph{host}
\texttt{10.251.9.1}. La Figura \ref{res:esc3:s1prime} muestra los resultados
obtenidos.
